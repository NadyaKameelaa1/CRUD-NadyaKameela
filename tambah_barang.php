...
<body>
    ...
    <form action="" method="">
        ...
        <input type="text" name="nama_barang" id="nama_barang" class="form-control" placeholder="Masukkan nama barang..."><br><br>

        <label for="stok" class="form-label"><b>Stok :</b></label><br>
        <input type="number" name="stok" id="stok" class="form-control" placeholder="Masukkan stok..."><br><br>

        <label for="harga" class="form-label"><b>Harga :</b></label><br>
        <input type="text" name="harga" id="harga" class="form-control" placeholder="Masukkan harga.."><br><br>
